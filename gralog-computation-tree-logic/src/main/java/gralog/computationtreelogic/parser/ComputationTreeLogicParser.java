...
public class ComputationTreeLogicParser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
    return ComputationTreeLogicScannerToken.class;
}
...
class CUP$ComputationTreeLogicParser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$ComputationTreeLogicParser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$ComputationTreeLogicParser$act_num)
		...
		Location fxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.peek()).xleft;
		Location fxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.peek()).xright;
		ComputationTreeLogicFormula f = (ComputationTreeLogicFormula)((java_cup.runtime.Symbol) CUP$ComputationTreeLogicParser$stack.peek()).value;
		 RESULT = f; 
          ...
          case 1: // $START ::= formula EOF 
            {
              Object RESULT =null;
		Location start_valxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.elementAt(CUP$ComputationTreeLogicParser$top-1)).xleft;
		Location start_valxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.elementAt(CUP$ComputationTreeLogicParser$top-1)).xright;
		...
		RESULT = start_val;
          ...
          case 2: // veeformula ::= wedgeformula VEE veeformula 
            {
              ComputationTreeLogicFormula RESULT =null;
		Location leftxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.elementAt(CUP$ComputationTreeLogicParser$top-2)).xleft;
		Location leftxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.elementAt(CUP$ComputationTreeLogicParser$top-2)).xright;
		...
		Location rightxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.peek()).xleft;
		Location rightxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.peek()).xright;
		...
		ComputationTreeLogicFormula f = (ComputationTreeLogicFormula)((java_cup.runtime.Symbol) CUP$ComputationTreeLogicParser$stack.peek()).value;
		 RESULT = f; 
          ...
          case 6: // atomicformula ::= STRING 
            {
              ComputationTreeLogicFormula RESULT =null;
		Location sxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.peek()).xleft;
		Location sxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.peek()).xright;
		String s = (String)((java_cup.runtime.Symbol) CUP$ComputationTreeLogicParser$stack.peek()).value;
		 ...
		 RESULT = new ComputationTreeLogicTop(); 
          ...
          case 9: // atomicformula ::= PARENTHESISLEFT formula PARENTHESISRIGHT 
            {
              ComputationTreeLogicFormula RESULT =null;
		Location fxleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.elementAt(CUP$ComputationTreeLogicParser$top-1)).xleft;
		Location fxright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.elementAt(CUP$ComputationTreeLogicParser$top-1)).xright;
		...
		ComputationTreeLogicFormula f = (ComputationTreeLogicFormula)((java_cup.runtime.Symbol) CUP$ComputationTreeLogicParser$stack.peek()).value;
		 RESULT = new ComputationTreeLogicAlwaysFinally(f); 
          ...
          case 14: // atomicformula ::= ALWAYS atomicformula UNTIL atomicformula 
            {
              ComputationTreeLogicFormula RESULT =null;
		Location f1xleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.elementAt(CUP$ComputationTreeLogicParser$top-2)).xleft;
		Location f1xright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.elementAt(CUP$ComputationTreeLogicParser$top-2)).xright;
		...
		Location f2xleft = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.peek()).xleft;
		Location f2xright = ((java_cup.runtime.ComplexSymbolFactory.ComplexSymbol)CUP$ComputationTreeLogicParser$stack.peek()).xright;
		...
		ComputationTreeLogicFormula f2 = (ComputationTreeLogicFormula)((java_cup.runtime.Symbol) CUP$ComputationTreeLogicParser$stack.peek()).value;
		 RESULT = new ComputationTreeLogicExistsUntil(f1,f2); 
          ...
          default:
            throw new Exception(
               "Invalid action number "+CUP$ComputationTreeLogicParser$act_num+"found in internal parse table");
  ...
  public final java_cup.runtime.Symbol CUP$ComputationTreeLogicParser$do_action(
    ...
    throws java.lang.Exception
    {
              return CUP$ComputationTreeLogicParser$do_action_part00000000(
                               CUP$ComputationTreeLogicParser$act_num,
                               CUP$ComputationTreeLogicParser$parser,
                               CUP$ComputationTreeLogicParser$stack,
                               CUP$ComputationTreeLogicParser$top);
    }
}
