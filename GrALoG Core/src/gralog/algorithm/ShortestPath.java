...
public class ShortestPath extends Algorithm
{
    ...
    public static void DijkstraShortestPath(Structure s, Vertex start, Vertex target,
            HashMap<Vertex, Vertex> predecessor, HashMap<Vertex,Edge> edgeFromPredecessor, HashMap<Vertex, Double> distances)
    {
    ...
    public static void DijkstraShortestPath(Structure s, Vertex start, HashMap<Vertex, Vertex> predecessor,
            HashMap<Vertex,Edge> edgeFromPredecessor, HashMap<Vertex, Double> distances)
    {
        DijkstraShortestPath(s, start, null, predecessor, edgeFromPredecessor, distances);
    }
    ...
    public Object Run(Structure s, AlgorithmParameters p, Set<Object> selection, ProgressHandler onprogress) throws Exception
    {
        ...
        DijkstraShortestPath(s, v1, v2, predecessor, edgeFromPredecessor, distances);
