...
public enum DialogAction {
    SELECT_ALL, SELECT_ALL_VERTICES, SELECT_ALL_EDGES,
    SELECT_LIST, // decide: select list (can be edges, vertices) or select list of vertices/ select list of edges
    DESELECT_ALL, DESELECT_ALL_VERTICES, DESELECT_ALL_EDGES,
    ...
    COMPLEMENT,
    PRINT,
    FIND_LIST, FIND_VERTEX, FIND_EDGE, FIND_GRAPH_ELEMENT,
    LAYOUT,
    CONNECT_CLIQUE, CONNECT_PATH, CONNECT_CYCLE, CONNECT_BICLIQUE, CONNECT_MATCHING, CONNECT_TCLOSURE,
      CONNECT_FORMULA, CONNECT_2_LISTS_FORMULA, CONNECT_SELFLOOP,
    HELP,
    NONE,
    SORT
}
